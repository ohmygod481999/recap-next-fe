        ...
        <div className="row">
          <div className="col-lg-3 responsive-column-half">
            <div className="footer-item">
              ...
              <p className="py-3 fs-15 lh-24">
                Exercitationem expedita id illum ipsum pariatur quia ratione
                sapiente soluta totam voluptate!
              </p>
          ...
          <div className="col-lg-3 responsive-column-half">
            <div className="footer-item">
              ...
              <ul className="generic-list-item generic-list-item-hover-underline pt-3">
                <li>
          ...
          <div className="col-lg-3 responsive-column-half">
            <div className="footer-item">
              <h3 className="fs-18 fw-bold pb-2">Legal Stuff</h3>
              <ul className="generic-list-item generic-list-item-hover-underline pt-3">
                <li>
          ...
          <div className="col-lg-3 responsive-column-half">
            <div className="footer-item">
              <h3 className="fs-18 fw-bold pb-2">Help</h3>
              <ul className="generic-list-item generic-list-item-hover-underline pt-3">
                <li>
