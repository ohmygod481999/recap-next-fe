...
import { REPLY_COMMENT } from "../../utils/apollo/entities/caption/operations/caption.mutations";
import { gql } from "@apollo/client";
import { GET_REPLY_OF_SINGLE_COMMENT } from "../../utils/apollo/entities/caption/operations/caption.queries";
function FormReplyComment({ dataId, getFakeData }) {
  ...
  return (
    <div className="comment-form">
      ...
      >
        <form method="post" className="row pb-3" onSubmit={_handleSubmit}>
