...
import { defaultCategoryId } from "../utils/helper/helpers";
...
import { allCaptionsVar } from "../utils/apollo/entities/caption";
import { useState, useEffect } from "react";
import CaptionContent from "../components/homeContentSection/CaptionContent";
export default function Captions({ data }) {
  const getTags = useQuery(GET_TAGS);
  const allTags = getTags.data ? getTags.data.tag : [];
  const [limit, setLimit] = useState(20);
  const [hasMore, setHasMore] = useState(true);
  const [captionsData, setCaptionsData] = useState(data);
  const [search, setSearch] = useState({
    search: "",
    tag: []
  });
  const [loadMoreCaption, result] = useLazyQuery(GET_ALL_CAPTIONS, {
    variables: { limit: limit }
  });
  const fetchMoreData = () => {
    if (captionsData?.caption.length >= 500) {
      setHasMore(false);
      return false;
    }
    loadMoreCaption({
      variables: {
        ...
        tag_id:
          search.tag.length === 0
            ? [
                "6bc47af3-b091-436e-81c1-d5c568aa084c",
                "7a4ccaae-31ef-4890-b176-e6a18131d509",
                "7cd43c38-4924-482e-b2db-8e2c5fda15de",
                "dd84b73d-f631-4096-8269-46772e175cf0",
                "c818577d-0492-483f-a821-4306dfa14cbf",
                "407658de-7070-4bf2-909e-0db274952442",
                "560bd5a5-eada-485c-8df7-83c5e98665b9"
              ]
            : search.tag
      }
    });
  ...
  const _handleChangeCheckBox = (e) => {
    if (e.target.checked) {
      setSearch((prev) => ({ ...prev, tag: [...prev.tag, e.target.value] }));
    } else {
      setSearch((prev) => ({
        ...prev,
        tag: [...prev.tag.filter((t) => t === e.target.value)]
      }));
    }
  };
      ...
      <section className="hero-area pt-80px pb-50px bg-white shadow-sm">
        ...
        <div className="container">
          <div className="hero-content text-center pb-5">
            <h2 className="section-title pb-3 theme-font-2 fs-40">
              Recaps - Captions recommendation
            </h2>
            <p className="section-desc">
              Bạn yêu thích mạng xã hội?
              <br />
              Bạn chụp được một bức ảnh đẹp nhưng không biết để caption là gì
              <br />
              hay chỉ đơn giản bạn thích những câu nói hay và hài hước. Recap sẽ
              giúp bạn.
            </p>
          ...
          {/* end hero-content */}
          <div className="row">
            <div className="col-lg-4 media align-items-center pb-30px responsive-column-half">
              <svg
                className="mr-3"
                width="45px"
                height="45px"
              ...
              >
                <path
                  style={{ fill: "#C7EAFF" }}
                  d="M286,184H70c-33.137,0-60,26.863-60,60v154c0,33.137,26.863,60,60,60h64.979l-0.901,0.078L178,502
                        l0.031-44H286c33.137,0,60-26.863,60-60V244C346,210.863,319.137,184,286,184z"
                />
                <path
                  d="M178.002,512c-2.603,0-5.16-1.016-7.073-2.929L129.858,468H70c-38.598,0-70-31.402-70-70V244c0-38.598,31.402-70,70-70h101
                ...
                <path
                  style={{ fill: "#FFBC53" }}
                  d="M366.655,10h-25.309C266.597,10,206,70.596,206,145.346l0,0c0,74.749,60.596,135.346,135.346,135.346
                ...
                />
                <path
                  d="M448.002,326.255c-2.602,0-5.158-1.016-7.071-2.927l-37.387-37.366c-12,3.14-24.381,4.729-36.89,4.729h-25.309
                ...
                />
                <path
                  d="M356.8,186.774c-5.522,0-10-4.477-10-10v-24.025c0-8.957,6.13-16.585,14.908-18.549
                ...
                />
                <path
                  d="M356.8,226.33c-2.63,0-5.21-1.06-7.07-2.92c-1.859-1.86-2.93-4.44-2.93-7.08c0-2.63,1.07-5.21,2.93-7.07
                ...
                <path
                  d="M275,386c-2.63,0-5.21-1.07-7.07-2.93S265,378.63,265,376s1.069-5.21,2.93-7.07c1.86-1.86,4.44-2.93,7.07-2.93
              ...
              >
                <g>
                  <g>
                    <g>
                      <path
                        d="m80.267 7.5c-25.124 0-45.492 20.367-45.492 45.492v406.017c0 25.124 20.367 45.492 45.492 45.492h300.284c25.124 0 45.492-20.367 45.492-45.492v-333.882c0-7.913-3.143-15.501-8.738-21.096l-87.792-87.792c-5.595-5.595-13.184-8.738-21.096-8.738h-228.15z"
                        fill="#f7f4f7"
                      />
                      <g>
                        <path
                          d="m417.305 104.03-56.639-56.639v411.617c0 25.124-20.367 45.492-45.492 45.492h65.377c25.124 0 45.492-20.367 45.492-45.492v-333.881c0-7.913-3.143-15.502-8.738-21.097z"
                          fill="#e0dde0"
                        />
                      </g>
                      <path
                        d="m417.305 104.03-87.792-87.792c-2.55-2.55-5.518-4.584-8.738-6.051v78.211c0 13.459 10.911 24.37 24.37 24.37h78.211c-1.467-3.22-3.501-6.187-6.051-8.738z"
                        fill="#efd133"
                      />
                    </g>
                    <g>
                      <path
                        d="m130.884 226.457h-36.596c-3.557 0-6.44-2.883-6.44-6.44v-36.596c0-3.557 2.883-6.44 6.44-6.44h36.596c3.557 0 6.44 2.883 6.44 6.44v36.596c0 3.557-2.883 6.44-6.44 6.44z"
                        fill="#e49542"
                      />
                      <path
                        d="m130.884 319.784h-36.596c-3.557 0-6.44-2.883-6.44-6.44v-36.596c0-3.557 2.883-6.44 6.44-6.44h36.596c3.557 0 6.44 2.883 6.44 6.44v36.596c0 3.556-2.883 6.44-6.44 6.44z"
                        fill="#95d6a4"
                      />
                      <path
                        d="m130.884 413.11h-36.596c-3.557 0-6.44-2.883-6.44-6.44v-36.596c0-3.557 2.883-6.44 6.44-6.44h36.596c3.557 0 6.44 2.883 6.44 6.44v36.596c0 3.557-2.883 6.44-6.44 6.44z"
                        fill="#e07f84"
                      />
                    </g>
                    <g>
                      <g>
                        <path
                          d="m429.739 292.024-31.709-31.709-5.735.339-153.687 153.687c-2.375 2.375-4.496 4.976-6.362 7.747l36.367 36.367c2.771-1.866 5.372-3.987 7.747-6.362l153.687-153.687z"
                          fill="#e07f84"
                        />
                        <path
                          d="m271.514 456.351-37.164-37.164c-3.133 4.024-5.679 8.486-7.521 13.267l-15.809 41.028c-1.495 3.88 2.319 7.693 6.198 6.198l41.028-15.809c4.782-1.841 9.244-4.387 13.268-7.52z"
                          fill="#a87f7f"
                        />
                        <path
                          d="m453.023 275.431-22.976 22.975-37.752-37.752 22.976-22.975 5.525.246 31.771 31.772z"
                          fill="#d1ccd3"
                        />
                      </g>
                    </g>
                    <path
                      d="m269.924 71.035h-174.594c-4.132 0-7.483 3.35-7.483 7.483v26.769c0 4.132 3.35 7.483 7.483 7.483h174.594c4.132 0 7.483-3.35 7.483-7.483v-26.77c0-4.132-3.35-7.482-7.483-7.482z"
                      fill="#bed8fb"
                    />
                    <path
                      d="m269.924 71.035h-65.377c4.132 0 7.482 3.35 7.482 7.483v26.769c0 4.133-3.35 7.483-7.482 7.483h65.377c4.132 0 7.482-3.35 7.482-7.483v-26.77c.001-4.132-3.349-7.482-7.482-7.482z"
                      fill="#9dc6fb"
                    />
                  </g>
                  <path
                    d="m469.422 221.279c10.425 10.425 10.425 27.327 0 37.752l-16.4 16.4-37.752-37.752 16.4-16.4c10.425-10.425 27.327-10.425 37.752 0z"
                    fill="#88a8d8"
                  />
                  <g>
            ...
            <div className="col-lg-4 media align-items-center pb-30px responsive-column-half">
              ...
              >
                <g>
                  <g>
                    <path
                      d="m483.375 275.673c-22.532-28.534-38.683-36.819-38.683-36.819h-377.385s-16.151 8.285-38.683 36.819c-9.528 12.066-6.42 29.753 6.609 37.914 28.293 17.722 77.555 52.959 124.079 107.678h193.374c46.525-54.719 95.786-89.956 124.079-107.678 13.031-8.162 16.138-25.848 6.61-37.914z"
                      fill="#ff748f"
                    />
                    <path
                      d="m188.333 414.829c-58.545-68.856-120.534-113.198-156.137-135.498-1.453-.91-2.804-1.919-4.058-3.004-8.918 12.043-5.701 29.245 7.097 37.261 28.293 17.722 77.555 52.959 124.079 107.678z"
                      fill="#fd5f7e"
                    />
                    <path
                      d="m50.59 212.91c0-113.263 92.147-205.41 205.41-205.41 113.264 0 205.41 92.147 205.41 205.41z"
                      fill="#77718c"
                    />
                    <path
                      d="m276 8.476c-6.583-.639-13.252-.976-20-.976-113.263 0-205.41 92.147-205.41 205.41h40c0-106.516 81.497-194.346 185.41-204.434z"
                      fill="#5c586f"
                    />
                    <circle
                      cx="426.995"
                    ...
                    />
                    <path
                      d="m332.358 368.749s80.291 41.586 80.291 135.751h-307.661c0-94.166 80.291-135.751 80.291-135.751z"
                      fill="#76e6d5"
                    />
                    <path
                      d="m210.279 368.748h-25s-80.291 41.586-80.291 135.751h25c0-94.165 80.291-135.751 80.291-135.751z"
                      fill="#00d6bc"
                    />
                    <path
                      d="m392.324 109.681c-12.553-16.55-35.056-21.854-53.842-12.99-19.762 9.324-48.958 19.462-82.482 19.462-33.523 0-62.718-10.137-82.48-19.461-18.968-8.949-41.543-3.335-54.166 13.415-21.821 28.953-34.652 65.063-34.344 104.184.753 95.343 78.474 171.133 173.808 169.592 93.138-1.505 168.176-77.476 168.176-170.972.001-38.782-12.912-74.545-34.67-103.23z"
                      fill="#fed2a4"
                    />
                    <path
                      d="m125.01 214.29c-.309-39.121 12.523-75.23 34.344-104.185 4.188-5.557 9.474-9.879 15.357-12.859-.399-.186-.8-.371-1.191-.555-18.968-8.949-41.543-3.335-54.166 13.415-17.26 22.902-28.889 50.285-32.846 80.09-.497-.019-.994-.039-1.504-.039-22.341 0-40.451 18.111-40.451 40.452s18.111 40.451 40.451 40.451c3.497 0 6.695-.444 9.601-1.279 23.651 67.59 88.355 115.327 164.213 114.101 5.793-.094 11.515-.476 17.154-1.132-84.602-9.775-150.27-80.86-150.962-168.46z"
                      fill="#ffbd86"
                    />
                    <path
                      d="m386.446 172.401c-5.764-18.527-26.641-27.605-44.096-19.131l-86.35 41.924-86.351-41.924c-17.455-8.474-38.331.604-44.096 19.131-3.984 12.805-6.132 26.412-6.132 40.512 0 18.375 3.65 35.914 10.261 51.93 6.907 16.734 26.684 23.985 42.969 16.078l83.349-40.466 83.348 40.466c16.286 7.907 36.062.656 42.969-16.078 6.611-16.017 10.261-33.555 10.261-51.93 0-14.101-2.148-27.707-6.132-40.512z"
                      fill="#ff748f"
                    />
                    <g fill="#f9f097">
          ...
          <div className="row">
              ...
              <div className="sidebar pb-45px position-sticky top-0">
                <ul className="generic-list-item generic-list-item-highlight fs-15">
                  ...
                  <li className="lh-26 active">
                    <Link href="/captions">
                      <a>
                        <i className="la la-list mr-1 text-black" /> All
                        captions
                      </a>
                    </Link>
                  </li>
            ...
            <div className="col-lg-7 px-0">
              <div className="question-main-bar border-left border-left-gray pb-50px">
                <div className="filters pl-3 d-flex align-items-center justify-content-between">
                  <div className="mr-3">
                    <h3 className="fs-18 fw-medium">Tất cả captions</h3>
                    {/* <p class="pt-1 fs-14 fw-medium lh-20">21,287 questions</p> */}
                  </div>
                </div>
                <form
                  method="post"
                  className="search-form py-3 rounded-0 bg-transparent shadow-none position-relative z-index-1"
                ...
                >
                      ...
                      <div className="form-group mr-3 flex-grow-1">
                        ...
                        <div className="km-select-wrap">
                          <select className="custom-select custom--select">
                            <option value={defaultCategoryId}>Caption</option>
                          </select>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="filter-btn-group d-flex flex-wrap align-items-center">
                    {allTags.map((tag) => (
                      <div
                        key={tag.id}
                        className="btn border border-gray bg-white lh-26 text-gray pl-40px custom-control custom-checkbox fs-14 d-inline-block mr-2 mb-2"
                      >
                        <input
                          type="checkbox"
                ...
                <div className="questions-snippet border-top border-top-gray">
                  <InfiniteScroll
                    dataLength={captionsData?.caption?.length}
                    next={fetchMoreData}
                    hasMore={hasMore}
                    loader={<Loading />}
